...
## Project Structure
    ...
    ├── testapiautostorybo_111835  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_111835`
...
2. Clone this repo and `cd testapiautostorybo_111835`
